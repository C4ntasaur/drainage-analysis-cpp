...
inline RGBTRIPLE interpolateColor(const RGBTRIPLE& color1, const RGBTRIPLE& color2, double t) {
    RGBTRIPLE result;
...
inline RGBTRIPLE getColourFromColourmapContinuous(double value, const std::vector<RGBTRIPLE>& colormap) {
